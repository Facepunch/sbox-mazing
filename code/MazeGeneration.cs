...
public static partial class MazeGenerator
{
    public static GeneratedMaze GenerateLobby()
    {
        ...
        return new GeneratedMaze( maze,
            exits[Game.Random.Int( exits.Length - 1 )],
            keys[Game.Random.Int( keys.Length - 1 )],
            players.OrderBy( x => Game.Random.Float() ).ToArray(),
            new[] { (TypeLibrary.GetType<Wanderer>(), enemies[Game.Random.Int( enemies.Length - 1 )]) },
    ...
    public static GeneratedMaze GenerateFinalLevel( int seed, int playerCount )
    {
        ...
        {
            new(20, 250, TypeLibrary.GetType<Wanderer>(), TypeLibrary.GetType<EliteWanderer>(), TypeLibrary.GetType<SpikeTrap>()),
            new(24, 200, TypeLibrary.GetType<Seeker>(), TypeLibrary.GetType<EliteSeeker>(), TypeLibrary.GetType<SpikeTrap>()),
            new(26, 150, TypeLibrary.GetType<Charger>(), TypeLibrary.GetType<EliteCharger>(), TypeLibrary.GetType<SpikeTrap>()),
            new(28, 100, TypeLibrary.GetType<Wizard>(), TypeLibrary.GetType<EliteWizard>(), TypeLibrary.GetType<SpikeTrap>()),
            new(30, 50, TypeLibrary.GetType<Keyhunter>(), TypeLibrary.GetType<EliteKeyhunter>(), TypeLibrary.GetType<SpikeTrap>()),
        };
